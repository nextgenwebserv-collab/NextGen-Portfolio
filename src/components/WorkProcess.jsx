    ...
    <section ref={sectionRef} className="px-2 sm:px-6">
      <div className="max-w-7xl mx-auto relative overflow-hidden rounded-[32px]">
        ...
        <div className="relative rounded-[32px] border border-violet-500/10 bg-white/40 backdrop-blur-xl shadow-[0_8px_40px_rgba(0,0,0,0.08)] p-6 sm:p-16 overflow-hidden">
          {/* Header */}
          <div className="mb-14">
            <div className="inline-flex items-center gap-2 px-5 py-2 rounded-full border border-black/20 bg-white/20 backdrop-blur-md text-sm text-black mb-8">
              <Code2 size={16} />
              Work Process
            </div>
            ...
            <div className="max-w-3xl mb-14">
              <h2 className="text-3xl sm:text-4xl font-bold leading-tight text-black">
                ...
                <span
                  key={currentText}
                  className={`ml-3 inline-block bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent font-bold transition-all duration-500 ease-in-out ${isVisible ? 'opacity-100 translate-y-0 blur-0' : 'opacity-0 -translate-y-4 blur-sm'}`}
                >
                  {texts[currentText]}
                </span>
              </h2>
...
function ProcessCard({ title, desc, icon: Icon, visible, delay }) {
  return (
    <div
      ...
      className={`
        ...
        bg-white/10 backdrop-blur-xl p-7
