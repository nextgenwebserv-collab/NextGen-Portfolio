...
export default function Testimonials() {
  return (
    <section className="relative py-16 sm:py-24 overflow-hidden">
      {/* Gradient background */}
      <div className="absolute top-80 sm:top-40 left-1/2 -translate-x-1/2 w-60 sm:w-96 h-60 sm:h-96 bg-violet-500/60 rounded-full blur-[100px] opacity-80"></div>

      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6">
        <span className="inline-flex items-center gap-2 border border-black/20 bg-white/20 backdrop-blur-md px-4 py-2 rounded-full text-sm mb-6 ">
          💬 Testimonials
        </span>
        ...
        <div className="flex flex-col justify-center md:flex-row gap-8 items-center">
          ...
          {/* Testimonial card */}
          <div className="group relative text-black overflow-hidden rounded-2xl border border-violet-500/10 bg-white/40 backdrop-blur-2xl p-6 sm:p-8 max-w-md transition-all duration-500 hover:-translate-y-2 hover:border-violet-400/40 hover:shadow-[0_20px_60px_rgba(168,85,247,0.25)]">
