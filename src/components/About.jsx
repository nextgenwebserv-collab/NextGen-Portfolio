export default function About() {
  return (
    <section id="about" className="relative py-18 sm:py-24 overflow-hidden">
      {/* Gradient background */}
      <div className="absolute top-40 sm:top-20 left-1/2 -translate-x-1/2 w-60 sm:w-96 h-60 sm:h-96 bg-violet-500/60 rounded-full blur-[100px] opacity-80"></div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-16">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-center gap-12">
          ...
          {/* Content Card */}
          <div className="group relative overflow-hidden rounded-2xl border border-violet-500/20 bg-white/40 backdrop-blur-2xl p-6 sm:p-10 max-w-lg transition-all duration-500 hover:-translate-y-2 hover:border-violet-400/40 hover:shadow-[0_20px_60px_rgba(168,85,247,0.25)]">
